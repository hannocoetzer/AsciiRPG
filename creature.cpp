...
creature::creature(int x,int y,bool temp_hero,char temp_look,bool temp_ai,int temp_speed,int temp_hitpoints,
							int temp_agility,char* temp_color,int temp_mapweaponcount,int temp_treasurecount,char* temp_weaponname,
										int temp_weapondamage,char* temp_name,int temp_x1,int temp_y1,int temp_x2,int temp_y2)
{
...
int creature::gettotal()
{

	return total;
}
int creature::getweaponcount()
{

	return weaponcount;
}
int creature::getpos_x()
{
	return pos_x;
}
int creature::getpos_y()
{
...
void creature::sethitpoints(int temp_hitpoints)
{
...
/*		This function does checking for all the characters that may not be crossed                         */
...
/*                                treasureverify is temorary and will change a bit		*/
	...
	if(hero)
	{
       ...
       treasuregrid[pos_y][pos_x] = 0;
							...
							if(treasureremain < 1)
							{
								...
								strcpy(str,"\n\n\nYou gathered all the treasures. Press [e] to exit or [c] to continue...");
